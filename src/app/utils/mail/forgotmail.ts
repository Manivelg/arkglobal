...
export const sendEmail = async (to: string, otp: string) => {
  const mailOptions = {
    ...
    to,
    subject: "ARK Global - Your Password Reset Code",
            ...
            <td class="column">
              ...
              <table class="content" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <td class="padded">
                      <p style="font-size:1rem; font-weight: 500;">Hi Sir/Madam,</p>
                      <p>Thank you for using ArkGlobal!.</p>
                      <p>
                        To complete your verification, please use the One-Time
                        Password (OTP) provided below:</p
                      >
                      <h2 class="otp_code">${otp}</h2>
                      <p
                        >This code is valid for <b>10 minutes.</b> For your
                        security, do not share this code with anyone.</p
                      >
